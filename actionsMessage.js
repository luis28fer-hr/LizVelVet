...
function enviarMensaje(servicio) {
    ...
    const phoneNumber = '+524482015506'; // Cambia este número por el tuyo
    // Mensaje que quieres que se envíe automáticamente
    const message = `¡Hola! 😊✨ Me encantaría agendar una cita para el servicio de *${servicio}* 💅💆‍♀️. Estoy muy interesada y quisiera saber todos los detalles: costo 💸, qué incluye 📋 y la disponibilidad de turnos 🕒. ¡Gracias por tu ayuda! 🌟`;
